...
STEERING_LEFT_PWM = 480   # pwm value for full left steering (use `donkey calibrate` to measure value for your car)
STEERING_RIGHT_PWM = 280   # pwm value for full right steering (use `donkey calibrate` to measure value for your car)
# 
